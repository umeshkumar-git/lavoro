...
| TC-02 | Task Management | "Create a task: Refactor dashboard CSS with high priority" | `createTask` | `createTask` | ✅ PASS | 0ms |
| TC-03 | Task Management | "Add to-do: Update dependencies in package.json" | `createTask` | `createTask` | ✅ PASS | 1ms |
| TC-04 | Task Management | "Put 'Deploy to staging' on my task list with high priority" | `createTask` | `createTask` | ✅ PASS | 0ms |
| TC-05 | Reminders | "Remind me to take medication at 8 PM tonight" | `addReminder` | `addReminder` | ✅ PASS | 0ms |
| TC-06 | Reminders | "Set a reminder for the design sync at 3pm" | `addReminder` | `addReminder` | ✅ PASS | 1ms |
...
| TC-09 | Day Planning | "Plan my day around my meetings and high priority tasks" | `createDailyPlan` | `createDailyPlan` | ✅ PASS | 0ms |
| TC-10 | Day Planning | "Build a schedule for my afternoon focus block" | `createDailyPlan` | `createDailyPlan` | ✅ PASS | 1ms |
...
| TC-14 | Knowledge Retrieval | "Find any documents about our cloud deployment architecture" | `queryDocuments` | `queryDocuments` | ✅ PASS | 0ms |
